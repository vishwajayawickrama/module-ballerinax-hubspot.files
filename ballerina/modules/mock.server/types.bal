...
public type FolderUpdateTaskLocatorAccepted record {|
    *http:Accepted;
    FolderUpdateTaskLocator body;
|};
...
public type ImportFromUrlTaskLocatorAccepted record {|
    *http:Accepted;
    ImportFromUrlTaskLocator body;
|};
